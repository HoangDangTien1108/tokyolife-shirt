    ...
    <>
        <div className='w-full flex navBarTablet:flex-row flex-col navBarTablet:pt-[40px] navBarTablet:pb-[100px] items-end contentXl:px-[160px] contentLg2:px-[120px] navBarTablet:px-[90px] p-0 scrollspay'>
            <div className='navBarTablet:w-[36%] w-[100%] content3XL:pr-[120px] navBarTablet:pr-[80px] navBarTablet:pl-[0px] pl-[16px]'>  
                ...
                <img className='w-full' src='images/Content1_1.png' alt=''/>
            </div>
            <div className='navBarTablet:w-[64%] w-full navBarTablet:pr-0 navBarTablet:py-0 py-[16px] pr-[16px]'>
                <img className='contentTablet:h-full w-full navBarTablet:h-[430px] bg-cover bg-center' src='images/Content1_2.png' alt=''/>
            </div>
        </div>
        ...
        <div className='flex navBarTablet:flex-row flex-col navBarTablet:pb-[80px] pb-0'>
            <div className='navBarTablet:w-[43%] w-[100%]'>
                <img className='w-full contentCotton:h-auto navBarTablet:h-[370px] h-auto' src='images/Content1_3.png' alt=''/>
            </div>
