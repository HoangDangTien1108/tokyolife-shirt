    ...
    <>
        <div className='WhybuyXl:px-[160px] navBarTablet:px-[80px] navBarTablet:py-[80px] sm:py-[50px] py-[24px] bg-backgroundCustomer flex flex-col items-center w-full'>
            <div className=''>
                ...
                text-gray-700'>Tại sao bạn nên mua sản phẩm TOKYOLIFE</h1>     
            </div>
            <div className='w-full flex navBarTablet:flex-row flex-col Whybuy2Xl:gap-[40px] navBarTablet:gap-[25px] items-center navBarTablet:pt-[80px]'>
                <div className='WhybuyXl:w-[50%] navBarTablet:w-[40%] w-[100%] navBarTablet:p-0 py-[25px] flex justify-center'>
